...
- (id)init
{
	...
	[cnAJ setContentSize:CGSizeMake( .9, .8 )];
	[self addChild:cnAJ];
	...
	[cnEZ setPosition: ccp( 0.25f, 0.06f  )];
	[cnEZ setContentSizeType:(CCSizeTypeNormalized)];
	[cnEZ setContentSize:CGSizeMake(.1, .09)];
	[self addChild:cnEZ];
	...
	[cnRR setPosition: ccp( 0.75f, 0.06f  )];
	[cnRR setContentSizeType:(CCSizeTypeNormalized)];
	[cnRR setContentSize:CGSizeMake(.1, .09)];
	[self addChild:cnRR];
	...
	[EZBtn setContentSizeType:(CCSizeTypeNormalized)];
	[EZBtn setContentSize:CGSizeMake(1.1, 1.1)];
	...
	[ResetBtn setContentSizeType:(CCSizeTypeNormalized)];
	[ResetBtn setContentSize:CGSizeMake(1.1, 1.1)];
...
- (IBAction) IamClicked:(id)sender
	...
	long lbj = [ccNB.name integerValue] - 1;
	NoteButton *NB = (NoteButton *)NotePics[lbj];
	NSLog(@"Button %li clicked with sound %i", lbj + 1, NB.sndNbr);
